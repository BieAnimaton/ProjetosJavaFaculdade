 ...
 * @author aluno
 */
public class TesteLayouts extends javax.swing.JFrame {

    /**
     * Creates new form TesteLayouts
     */
    public TesteLayouts() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TesteLayouts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TesteLayouts().setVisible(true);
            }
        });
    }
